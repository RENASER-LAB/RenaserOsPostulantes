...
| **Los tiempos del sembrador siguen sin medir** | El 25/09/2026 se arreglaron los 16 e2e que fallaban desde antes (`04-filtros`, `05-excel`, `07-movil`, `08-teclado`): el ranking se intercepta con el escenario en el navegador y `05-excel` lee la hoja única «Datos». Queda **medir** la vía «interceptar» contra la vía «sembrar la base» (el script de Python, ya corregido, y su copia en TypeScript) y anotar los tiempos en [SUITE-E2E-CLASIFICACION-2026-09-25.md](SUITE-E2E-CLASIFICACION-2026-09-25.md); hasta entonces el script `sembrar-escenario-e2e.py` del backend no se borra |
