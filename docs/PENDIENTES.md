...
| **La tabla del ranking y el Excel no tienen las mismas columnas de criterio en la vacante 13** | Desde el 26/09/2026 el Excel de «Prueba del puesto» saca solo los criterios de la prueba que la vacante tiene puesta hoy. La tabla, al marcar «Ver los criterios en la tabla», sigue juntando los de todas sus filas, así que en la 13 —que cambió de prueba con gente dentro— enseña también las 4 columnas de la demo, vacías para casi todos. Se dejó fuera a propósito (25/09/2026); arreglarlo es otra spec. Anotado en los defectos conocidos del backend, el 15 |
| **La casilla «Ponderado» del menú «Columnas» se solapa** | Lleva como etiqueta su explicación larga y se monta sobre «#» y «Veredicto». Viene de antes; lo vio QA el 26/09/2026, fuera de la entrega del Excel. Está también entre los pendientes de la auditoría de código del backend |
